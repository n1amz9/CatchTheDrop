...
public class GameWindow extends JFrame {
    ...
    private static float drop_left= 0; // положение по y
    private static float drop_top = 100; // положение капли сверху x
    private static float drop_v = 100; // drop speed
    ...
    private static void onRepaint(Graphics g) {
        ...
        drop_top = drop_top + drop_v * delta_time; // логика движения капли
